					...
					<div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
						<form className="hidden lg:block">
							...
							>
								<li className="mt-8 space-y-4">
									<button
										...
										className="flex w-full items-center justify-center gap-2 rounded-full bg-[#53B5FF]/95 px-4 py-3 text-center font-medium text-gray-100"
									>
							...
							{!apiEndpoint && (
								<p className="text-xs font-semibold text-red-500">
									Note: All features are disabled as API is not available!
								</p>
							)}
						</form>
						...
						<div className="lg:col-span-3">
							<div className="relative">
								...
								/>
								{isGenerating && (
									<div className="absolute inset-0 flex items-center justify-center bg-gray-800/25 bg-opacity-50 backdrop-blur-md">
										<ProgressIndicator />
									</div>
								)}
							</div>
							...
							<div className="mt-6 flex items-center justify-between">
								<div className="text flex items-center gap-2.5 font-medium text-gray-400">
									<svg
										className="h-5 w-5"
